...
public enum QuestBranches {
  ...
  COOKS_ASSISTANT(
      () -> {
        ...
        questBranch.addLeafs(
            new TalkToCookLeaf(),
            new RetrievePotOfFlourBranch()
                .addLeafs(
                    new RetrievePotLeaf(), new RetrieveGrainLeaf(), new OperateGrainMillLeaf()),
  ...
  MONKS_FRIEND(
      () -> {
        ...
        questBranch.addLeafs(new TalkToBrotherOmadLeaf(), new RetrieveChildsBlanketLeaf());
        return questBranch;
      }),
  ...
  IMP_CATCHER(
      () -> {
        ...
        questBranch.addLeafs(new RetrieveBeadsLeaf(), new GiveBeadsLeaf());
        return questBranch;
      }),
  ...
  SHEEP_SHEARER(
      () -> {
        ...
        questBranch.addLeafs(new CollectWoolLeaf(), new SpinWoolLeaf(), new TalkToFredLeaf());
        return questBranch;
      }),
