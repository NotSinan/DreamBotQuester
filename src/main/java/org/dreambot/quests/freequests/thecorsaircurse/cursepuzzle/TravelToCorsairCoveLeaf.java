...
public class TravelToCorsairCoveLeaf extends Leaf {
  ...
  private static final Area CORSAIR_COVE_GROUND_LEVEL =
      new Area(
          new Tile[] {
  ...
  public boolean isValid() {
    final Area CORSAIR_COVE_GROUND_LEVEL =
        new Area(
            new Tile[] {
              new Tile(2471, 2876, 0),
              new Tile(2498, 2879, 0),
  ...
  public int onLoop() {
    ...
    if (CAPTAIN_TOCK_RIMMINGTON_TILE.distance() > 145) {
      WalkingHelper.walkToArea(CORSAIR_COVE_GROUND_LEVEL);
      return Timing.getSleepDelay();
    }
    return NPCHelper.goAndInteractWithNPC(
        CAPTAIN_TOCK_PORT,
        "Captain Tock",
        "Travel",
        () -> !CAPTAIN_TOCK_PORT.contains(Players.getLocal()));
  }
}
