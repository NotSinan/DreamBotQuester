...
public class TalkToLuthasLeaf extends Leaf {
  ...
  public boolean isValid() {
    return SmuggleState.isOnKaramja()
        && ((!SmuggleState.talkedLuthasBeforeBananas
  ...
  public int onLoop() {
    if (Dialogues.inDialogue()) {
      ...
      if (dialog != null) {
        ...
        if (dialog.contains("Well done, here's your payment.")) {
          Logger.log(
              "Luthas has ended your seasonal assignment due to changing business needs - pick up"
                  + " rum in Sarim Food Shop");
    ...
    final String[] DIALOGUE_OPTIONS = {
      "Could you offer me employment on your plantation?", "What did I have to do again?"
    };
