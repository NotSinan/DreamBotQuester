...
public class TalkToVeos extends Leaf {
    ...
    private final String[] DIALOGUE_OPTIONS = {"I'm looking for a quest.", "Sounds good, what should I do?", "Okay, thanks Veos.", "Yes."};
    private final String VEOS = "Veos";
    ...
    @Override
    public int onLoop() {
        return QuestHelper.goAndTalkToNpc(VEOS_AREA, VEOS, DIALOGUE_OPTIONS);
    }
}
