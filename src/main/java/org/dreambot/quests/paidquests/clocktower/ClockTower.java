...
public class ClockTower extends Branch {
    ...
    public boolean isValid() {
        if (shouldAddStairs) {
            LocalPathFinder.getLocalPathFinder().addObstacle(new ClimbableObstacle("Staircase", "Climb-up", null, null, null));
            LocalPathFinder.getLocalPathFinder().addObstacle(new ClimbableObstacle("Staircase", "Climb-down", null, null, null));
